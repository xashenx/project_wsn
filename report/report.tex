...
\subsubsection{Newlink}
	\begin{table}[H]
		...
		\begin{tabular}{*{2}{m{0.48\textwidth}}}
			\hline
			This is some text&\begin{center}\includegraphics[scale=.4]{graphs/newlink_0_start}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/newlink_1_routing}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/newlink_2_remove}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/newlink_3_add1}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/newlink_4_add2}\end{center}\\
			\hline
		\end{tabular}
...
\subsubsection{Test}
	\begin{table}[H]
		...
		\begin{tabular}{*{2}{m{0.48\textwidth}}}
			\hline
			This is some text&\begin{center}\includegraphics[scale=.4]{graphs/test_0_start}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/test_1_routing}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/test_2_remove}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/test_3_new}\end{center}\\
			\hline
		\end{tabular}
		\label{tab:newlinkIndepth}
	\end{table}
\subsubsection{Stable}
	\begin{table}[H]
		...
		\begin{tabular}{*{2}{m{0.48\textwidth}}}
			\hline
			This is some text&\begin{center}\includegraphics[scale=.4]{graphs/stable_0_start}\end{center}\\
			\hline
			stica&\begin{center}\includegraphics[scale=.4]{graphs/stable_1_routing}\end{center}\\
			\hline
		\end{tabular}
		\label{tab:newlinkIndepth}
	\end{table}
